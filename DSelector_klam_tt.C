#include "DSelector_klam_tt.h"

void DSelector_klam_tt::Init(TTree *locTree)
{
	...
	dOutputFileName = "klam_tt.root"; //"" for none
...
Bool_t DSelector_klam_tt::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(const auto& loc_combo : loc_combos)
	{
		...
		//Step 1
		Int_t locMuonMinusTrackID = dMuonMinusWrapper->Get_TrackID();
		...
		//Step 1
		TLorentzVector locMuonMinusP4 = dMuonMinusWrapper->Get_P4();
		TLorentzVector locProtonP4 = dProtonWrapper->Get_P4();
		TLorentzVector locMissingNeutrinoP4 = dMissingNeutrinoWrapper->Get_P4();
		...
		//Step 1
		TLorentzVector locMuonMinusP4_Measured = dMuonMinusWrapper->Get_P4_Measured();
		...
		locMissingP4_Measured -= locKPlusP4_Measured + locMuonMinusP4_Measured + locProtonP4_Measured;
		...
		*/
		...
		locUsedThisCombo_MissingMass[MuonMinus].insert(locMuonMinusTrackID);
...
void DSelector_klam_tt::Finalize(void)
{
